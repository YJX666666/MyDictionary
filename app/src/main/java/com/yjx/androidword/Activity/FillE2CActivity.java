...
public class FillE2CActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void getJudg(String answer) {
        ...
        if (answer.equals(mList.get(0).getChinses())) {
            mEditAnswer.setTextColor(Color.GREEN);
        } else {
            mEditAnswer.setTextColor(Color.RED);
            mTxvAnswer.setText("正确答案：" + mList.get(0).getChinses());
        }
    ...
    private void setData() {
        ...
        mTxvWord.setText(mList.get(0).getEnglish());
        mTxvAnswer.setText("");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.txv_grasp://掌握了单词
                ...
                txvEnglish.setText(mList.get(0).getEnglish());
                txvChinese.setText(mList.get(0).getChinses());
                ...
                txvDel.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        removeData(mList.get(0).getEnglish());
                        if (cursorCount() == 0) {
                            finish();
